...
const SkillsList = () => {
  ...
  const skills = {
    "What technologies does this template use?": [
      "This template highlights a modern web stack: Astro, React, Tailwind CSS, JavaScript, TypeScript, Node.js, Express, MongoDB, and common deployment tools.",
    ],
    "What experience should go here?": [
      "Use this section to summarize client work, product teams, freelance projects, open-source contributions, or hands-on learning that supports your portfolio story.",
    ],
    "How should I describe my education?": [
      "Describe your formal training, courses, certifications, self-directed learning, and the practical projects that helped you grow as a developer.",
    ],
    "How do I work with teams?": [
      "Explain how you collaborate with designers, developers, product stakeholders, and clients using clear communication, version control, and project management tools.",
    ],
    "Which workflow should I mention?": [
      "Mention the workflows you actually use, such as Scrum, Kanban, pull requests, code review, daily check-ins, issue tracking, and deployment routines.",
    ],
  };
    ...
    <div className="flex flex-col items-center text-left mx-auto max-w-6xl px-4">
      <div className="site-container mt-10">
        <h2 class="text-4xl font-bold flex flex-col items-center gap-6 text-center whitespace-nowrap text-white md:flex-row md:items-center md:text-end">
          ...
          <span class="drop-shadow-[2px_2px_0_#7836cf]">More About This Template</span>
        </h2>
